function Liked({ user }) {
  return (
    <div className="text-center my-10">
      ...
      <h3 className="text-xl md:text-2xl text-black/90 font-bold mb-2">This user's liked videos are private</h3>
      <p className="text-sm md:text-base text-black/50">Videos liked by {user.nickname} are currently hidden</p>
    </div>
  )
}
